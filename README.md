...
* Función Principal: La página (document) ejecuta un evento padre (addEventListener()) cuando termina de cargarse (DOMContentLoaded) e iniciliza los eventos y funciones siguientes: Cargar carrito, eventos click sobre botones, etc. 
